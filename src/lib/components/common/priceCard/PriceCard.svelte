...
>
	<div class="flex flex-col justify-between h-full">
		<section>
			...
			<section class="mt-8 ">
				<p class="text-night font-semibold text-lg border-y w-full text-center capitalize py-1 bgnight ">features</p>
		...
		<div class="h-12">
			<Button class="w-full font-normal bg-night text-lg h-full">get plan</Button>
		</div>
	</div>
</section>
